...
2. **Forms:**
   - Have Formik/validation schemas been updated?
...
# For other projects - check package.json or README
```
...
6. Reviews critical file diffs: Shows diff for projects.go
