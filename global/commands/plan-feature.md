...
3. UX review with Safe vs Bold pattern (UX Expert agent)
...
### Step 3: UX Review with Safe vs Bold Pattern

Spawn a UX Expert agent to generate design options using Safe vs Bold pattern:
...
```
Task(general-purpose): "Act as a Senior UX Expert. I need Safe and Bold design options for [feature description].
...
**SAFE DESIGN:**
Design the conservative, risk-minimizing version. Optimize for:
...
**BOLD DESIGN:**
Design the innovative, efficiency-maximizing version. Optimize for:
...
**SYNTHESIS:**
Propose how to combine the best of both:
- Default experience (what most users see first)
- Advanced mode (how power users access Bold features)
- Progressive disclosure (how users graduate from Safe → Bold)
- Phased rollout strategy (Safe in Phase 1, Bold in Phase 2?)

**For each design (Safe, Bold, Synthesis), describe:**
...
- Existing patterns: [key findings from Step 2]
- UX approach: [Safe/Bold/Synthesis from Step 3, or 'backend-only' if no UX review]
...
- **Feature stories:** User-facing functionality (Safe approach first, Bold enhancements later)
...
- [ ] Stories follow Safe → Bold progression (if applicable)
...
5. **Phased rollout:** Safe approach before Bold enhancements
...
- Goal: Feature is usable by target users (Safe approach)
- Risk: Medium

**Phase 3: Bold Enhancements (Differentiation)**
...
### Safe Approach (Phase 1 MVP)
- [Summary of Safe design]
- User flow: [entry → completion]
- Key UI elements: [forms, buttons, modals]
- Strengths: [why this works for first-time users]

### Bold Approach (Phase 2-3 Enhancements)
- [Summary of Bold design]
- User flow: [entry → completion]
- Key UI elements: [advanced features, efficiency tools]
- Strengths: [why this differentiates us]

### Recommended Synthesis
- [Strategy: progressive disclosure, phased rollout, etc.]
- Default experience: [Safe approach]
- Advanced mode: [How power users access Bold features]
- Discovery path: [How users learn about Bold features]
...
5. Add Phase 3 (Bold features) based on user feedback
...
1. I can create these stories in Linear using `/story` skill
...
5. Confirm creation with the user, providing Linear story links
...
- **Story quality:** 100% of stories from plan are accepted in Linear
- **Risk coverage:** 100% of high-risk features have blast radius analysis
- **UX coverage:** 100% of user-facing features have Safe vs Bold analysis
...
3. **Step 3:** Spawn UX Expert agent
   - Safe: Wizard with percentage input, preview, confirm
   - Bold: Spreadsheet-style inline editing with bulk ops
   - Synthesis: Wizard default + "Edit as spreadsheet" button
...
6. **Step 6:** Story breakdown
   ...
   - Story 3: Wizard UI (Safe approach, Phase 1)
   - Story 4: Spreadsheet editing (Bold approach, Phase 2)
...
9. **Use progressive disclosure** - Safe first, Bold later (phased approach)
...
- **UX Expert pattern** - Used in Step 3 following Safe vs Bold framework (guide 08)
- **Universal Blast Radius Framework** - Used in Step 5 (guide 07)
