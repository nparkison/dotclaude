...
6. Create in Shortcut only after explicit approval

**Design work (UX Expert, Safe vs Bold) is opt-in only - never automatic.**
...
Ready to create in Shortcut? (Reply "yes" to create, or provide feedback for revisions)
```

**Do not create the story in Shortcut yet. Wait for explicit user approval.**

---

### Step 6: Create in Shortcut (only after approval)

Once user explicitly approves ("yes", "approve", "create it"):

1. Use Shortcut MCP tool to create the story
...
4. Confirm creation with Shortcut story link
...
- Acknowledge and do not create in Shortcut
...
If user explicitly asks for UX/design feedback or Safe vs Bold analysis:
...
- [ ] Awaiting approval before Shortcut creation
...
5. **Wait for approval** - Never create in Shortcut without explicit "yes"
