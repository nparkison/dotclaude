...
If the user wants an external document (e.g., Google Doc) for the external version, use your preferred document creation tool. Ask the user before creating it — not every release needs an external doc.
